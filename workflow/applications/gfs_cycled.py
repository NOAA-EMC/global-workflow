...
class GFSCycledAppConfig(AppConfig):
    ...
    def _get_app_configs(self):
        ...
        if self.do_jediatmvar:
            configs += ['prepatmiodaobs', 'atmanlinit', 'atmanlrun', 'atmanlinc', 'atmanlfinal']
        else:
    ...
    def get_task_names(self):
        ...
        if self.do_jediatmvar:
            gdas_gfs_common_tasks_before_fcst += ['prepatmiodaobs', 'atmanlinit', 'atmanlrun', 'atmanlinc', 'atmanlfinal']
        else:
