...
class SFSTasks(Tasks):
    ...
    def atmos_post(self):
        ...
        member_task_dict = {'task_name': task_name,
                            ...
                            'cycledef': self.run,
                            'dependency': dependencies,
                            'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/atmos_post.sh',
                            'job_name': f'{self.pslot}_{task_name}_@H',
                            'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                            'maxtries': '&MAXTRIES;'
                            }
    ...
    def ocn_post(self):
        ...
        member_task_dict = {'task_name': task_name,
                            ...
                            'cycledef': self.run,
                            'dependency': dependencies,
                            'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/ocn_post.sh',
                            'job_name': f'{self.pslot}_{task_name}_@H',
                            'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                            'maxtries': '&MAXTRIES;'
                            }
    ...
    def ice_post(self):
        ...
        member_task_dict = {'task_name': task_name,
                            ...
                            'cycledef': self.run,
                            'dependency': dependencies,
                            'command': f'{self.HOMEglobal}/dev/job_cards/rocoto/ice_post.sh',
                            'job_name': f'{self.pslot}_{task_name}_@H',
                            'log': f'{self.rotdir}/logs/@Y@m@d@H/{task_name}.log',
                            'maxtries': '&MAXTRIES;'
                            }
