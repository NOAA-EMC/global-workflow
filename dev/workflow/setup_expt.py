...
def input_args(*argv):
    ...
    def _common_args(parser):
        ...
        parser.add_argument('--interval', help='frequency of forecast (in hours); must be a multiple of 6 or 0 for no forecasts', type=_validate_interval, required=False, default=6)
