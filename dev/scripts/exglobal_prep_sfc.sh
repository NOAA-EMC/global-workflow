...
export MODEL_LONGITUDE_FILE=${MDL_LONS:-${FIXgfs}/am/global_longitudes.t${JCAP_CASE}.${LONB_CASE}.${LATB_CASE}.grb}
export GFS_LONSPERLAT_FILE=${LONSPERLAT:-${FIXgfs}/am/global_lonsperlat.t${JCAP_CASE}.${LONB_CASE}.${LATB_CASE}.txt}
...
if [[ "${EUPD_CYC}" = "${RUN}" ]] || [[ "${EUPD_CYC^^}" = "BOTH" ]]; then
    ...
    export MODEL_SLMASK_FILE=${SLMASK_ENKF:-${FIXgfs}/am/global_slmask.t${JCAP_CASE_ENS}.${LONB_CASE_ENS}.${LATB_CASE_ENS}.grb}
    export MODEL_LATITUDE_FILE=${MDL_LATS_ENKF:-${FIXgfs}/am/global_latitudes.t${JCAP_CASE_ENS}.${LONB_CASE_ENS}.${LATB_CASE_ENS}.grb}
    export MODEL_LONGITUDE_FILE=${MDL_LONS_ENKF:-${FIXgfs}/am/global_longitudes.t${JCAP_CASE_ENS}.${LONB_CASE_ENS}.${LATB_CASE_ENS}.grb}
    export GFS_LONSPERLAT_FILE=${LONSPERLAT_ENKF:-${FIXgfs}/am/global_lonsperlat.t${JCAP_CASE_ENS}.${LONB_CASE_ENS}.${LATB_CASE_ENS}.txt}
