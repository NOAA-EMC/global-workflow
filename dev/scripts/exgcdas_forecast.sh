...
##		4. Global O3 data, ${FIXgcafs}/am/${O3FORC}
##		5. Global H2O data, ${FIXgcafs}/am/${H2OFORC}
##		6. Global solar constant data, ${FIXgcafs}/am/global_solarconstant_noaa_an.txt
##		7. Global surface emissivity, ${FIXgcafs}/am/global_sfc_emissivity_idx.txt
##		8. Global CO2 historical data, ${FIXgcafs}/am/global_co2historicaldata_glob.txt
##		8. Global CO2 monthly data, ${FIXgcafs}/am/co2monthlycyc.txt
##		10. Additional global CO2 data, ${FIXgcafs}/am/fix_co2_proj/global_co2historicaldata
##		11. Climatological aerosol global distribution
##			${FIXgcafs}/am/global_climaeropac_global.txt
## 		12. Monthly volcanic forcing ${FIXgcafs}/am/global_volcanic_aerosols_YYYY-YYYY.txt
##
...
source "${USHgcafs}/forecast_predet.sh"       # include functions for variable definition
source "${USHgcafs}/forecast_det.sh"          # include functions for run type determination
source "${USHgcafs}/forecast_postdet.sh"      # include functions for variables after run type determination
source "${USHgcafs}/parsing_ufs_configure.sh" # include functions for ufs_configure processing

source "${USHgcafs}/atparse.bash" # include function atparse for parsing @[XYZ] templated files
