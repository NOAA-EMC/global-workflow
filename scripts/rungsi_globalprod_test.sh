...
#ADC satinfo=$fixgsi/global_satinfo.txt
satinfo=$fixgsi/global_satinfo_new.txt
scaninfo=$fixgsi/global_scaninfo.txt
satangl=$fixgsi/global_satangbias_new.txt
...
ln -s -f $datges/${prefix_tbc}.satang.270             ./satbias_angle
