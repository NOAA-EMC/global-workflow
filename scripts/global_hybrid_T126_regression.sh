...
if [[ "$machine" = "Zeus" ]]; then
   ...
   /bin/sh sub_zeus -j $global_hybrid_T126_updat_exp1 -t 0:15:00 -p 6/6/0 $scripts/global_hybrid_T126.sh
   ...
   /bin/sh sub_wcoss -j $global_hybrid_T126_updat_exp1 -q $queue -p 16/2/ -r /1 -t 0:25:00 $scripts/global_hybrid_T126.sh
   ...
   rm -f return_code_global_hybrid_3dvar.out
   /bin/sh sub_wcoss -j $global_hybrid_T126_updat_exp2 -q $queue -p 16/4/ -r /2 -t 0:15:00 $scripts/global_hybrid_T126.sh
   ...
   rm -f return_code_global_hybrid_3dvar.out
   /bin/sh sub_wcoss -j $global_hybrid_T126_contrl_exp1 -q $queue -p 16/1/ -r /1 -t 0:25:00 $scripts/global_hybrid_T126.sh
   ...
   rm -f return_code_global_hybrid_3dvar.out
   /bin/sh sub_wcoss -j $global_hybrid_T126_contrl_exp2 -q $queue -p 16/4/ -r /2 -t 0:15:00 $scripts/global_hybrid_T126.sh
