...
if [[ "$machine" = "Zeus" ]]; then
   ...
   /bin/sh sub_wcoss -j $global_lanczos_T62_updat_exp1 -q $queue -p 16/2/ -r /1 -t 0:25:00 $scripts/global_lanczos_T62.sh
   ...
   rm -f return_code_global_lanczos_3dvar.out
   /bin/sh sub_wcoss -j $global_lanczos_T62_updat_exp2 -q $queue -p 16/4/ -r /2 -t 0:15:00 $scripts/global_lanczos_T62.sh
   ...
   rm -f return_code_global_lanczos_3dvar.out
   /bin/sh sub_wcoss -j $global_lanczos_T62_contrl_exp1 -q $queue -p 16/2/ -r /1 -t 0:25:00 $scripts/global_lanczos_T62.sh
   ...
   rm -f return_code_global_lanczos_3dvar.out
   /bin/sh sub_wcoss -j $global_lanczos_T62_contrl_exp2 -q $queue -p 16/4/ -r /2 -t 0:15:00 $scripts/global_lanczos_T62.sh
