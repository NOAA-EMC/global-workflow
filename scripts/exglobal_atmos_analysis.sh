...
IASINGBF=${IASINGBF:-${COMIN_OBS}/${OPREFIX}mtias2.tm00.bufr_d${OSUFFIX}}
ESIASING=${ESIASING:-${COMIN_OBS}/${OPREFIX}esias2.tm00.bufr_d${OSUFFIX}}
IASINGDB=${IASINGDB:-${COMIN_OBS}/${OPREFIX}ias2db.tm00.bufr_d${OSUFFIX}}
...
${NLN} ${IASINGBF}         iasingbufr
${NLN} ${ESIASING}         iasingbufrears
${NLN} ${IASINGDB}         iasingbufr_db
...
&OBSQC
  ...
  iasi_cads=${IASI_CADS},iasing_cads=${IASING_CADS},
  ${OBSQC}
/
&OBS_INPUT
