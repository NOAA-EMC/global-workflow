...
#  Next, paths for canned case data.
   ...
   export global_hybrid_T126_datges=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_hybrid_T126_adate/ges
   ...
   export global_enkf_T62_datges=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_enkf_T62_adate/ges
