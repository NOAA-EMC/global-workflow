...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export group=global
   export queue=batch
   export basedir=/scratch1/portfolios/NCEPDEV/da/save/$LOGNAME/svn/gsi
   export gsisrc=$basedir/EXP-enkfregtest/src
   export gsiexec_updat=$basedir/EXP-enkfregtest/src/global_gsi
   export gsiexec_contrl=$basedir/trunk/src/global_gsi
   export enkfexec_updat=$basedir/EXP-enkfregtest/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/trunk/src/enkf/global_enkf
   export fixgsi=$basedir/EXP-enkfregtest/fix
   export scripts=$basedir/EXP-enkfregtest/scripts
...
#  Next, paths for canned case data.
   ...
   export global_hybrid_T126_datobs=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_hybrid_T126_adate/obs
   export global_hybrid_T126_datges=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_hybrid_T126_adate/ges_lores
   export global_enkf_T62_datobs=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_enkf_T62_adate/obs
   export global_enkf_T62_datges=/scratch1/portfolios/NCEPDEV/da/noscrub/Russ.Treadon/CASES/global/sigmap/$global_enkf_T62_adate/ges_lores
...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export group=dev
   export queue=dev
   export basedir=/global/save/$LOGNAME/svn/gsi
   export gsisrc=$basedir/EXP-enkfregtest/src
   export gsiexec_updat=$basedir/EXP-enkfregtest/src/global_gsi
   export gsiexec_contrl=$basedir/trunk/src/global_gsi
   export enkfexec_updat=$basedir/EXP-enkfregtest/src/enkf/global_enkf
   ...
   export scripts=$basedir/EXP-enkfregtest/scripts
   export tmpdir=/ptmpd1/$LOGNAME
   export savdir=/ptmpd1/$LOGNAME
...
#  Next, paths for canned case data.
   ...
   export global_hybrid_T126_datobs=/global/noscrub/Russ.Treadon/CASES/global/sigmap/$global_hybrid_T126_adate/obs
   export global_hybrid_T126_datges=/global/noscrub/Russ.Treadon/CASES/global/sigmap/$global_hybrid_T126_adate/ges
   export global_enkf_T62_datobs=/global/noscrub/Russ.Treadon/CASES/global/sigmap/$global_enkf_T62_adate/obs
   export global_enkf_T62_datges=/global/noscrub/Russ.Treadon/CASES/global/sigmap/$global_enkf_T62_adate/ges
