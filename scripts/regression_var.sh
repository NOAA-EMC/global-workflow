...
#  fix, ptmp, and CRTM coefficient files.
   ...
   if [[ "$machine" = "Zeus" ]]; then
      ...
      export fixcrtm=/scratch1/portfolios/NCEPDEV/da/save/Michael.Lueken/CRTM_REL-2.2.0b/crtm_v2.2.0-beta/fix
      ...
      export fixgsi=$basedir/EXP-testCRTM_R2.2/fix
      export scripts=$basedir/EXP-testCRTM_R2.2/scripts
      export fixcrtm=/scratch4/NCEPDEV/da/save/Michael.Lueken/nwprod/lib/crtm/2.2.0b/fix
   fi
