...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/EXP-Theia_transition/src
   export gsiexec_updat=$basedir/EXP-Theia_transition/src/global_gsi
   export gsiexec_contrl=$basedir/svn1/src/global_gsi
   export enkfexec_updat=$basedir/EXP-Theia_transition/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/svn1/src/enkf/global_enkf
   export fixgsi=$basedir/EXP-Theia_transition/fix
   export scripts=$basedir/EXP-Theia_transition/scripts
