...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/HyEK_NSST/src
   export gsiexec_updat=$basedir/HyEK_NSST/src/global_gsi
#  export gsiexec_contrl=$basedir/svn1/src/global_gsi
   ...
   export fixgsi=$basedir/HyEK_NSST/fix
   export scripts=$basedir/HyEK_NSST/scripts
