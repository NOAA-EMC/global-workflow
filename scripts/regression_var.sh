...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/minversion/src
   export gsiexec_updat=$basedir/minversion/src/global_gsi
   export gsiexec_contrl=$basedir/trunk/src/global_gsi
   export enkfexec_updat=$basedir/minversion/src/enkf/global_enkf
