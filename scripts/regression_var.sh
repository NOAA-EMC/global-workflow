...
export subversion="/global/save/$USER/sliu_rw/src/global_gsi"
...
export exp1_global_lanczos_sub_1node="global_lanczos.sub.1node"
...
export exp2_global_lanczos_sub_2node="global_lanczos.sub.2node"
...
export exp1_global_lanczos_bench_1node="global_lanczos.bench.1node"
...
export exp2_global_lanczos_bench_2node="global_lanczos.bench.2node"
...
export control_global_lanczos_T62="$noscrub/tmp${global_lanczos}/$exp1_global_lanczos_bench_1node"
export control_global_lanczos_T622="$noscrub/tmp${global_lanczos}/$exp2_global_lanczos_bench_2node"
