...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/cloudy_radiance/src
   export gsiexec_updat=$basedir/cloudy_radiance/src/global_gsi
   export gsiexec_contrl=$basedir/cloudy_radiance/src_orig/global_gsi
   export enkfexec_updat=$basedir/cloudy_radiance/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/cloudy_radiance/src_orig/enkf/global_enkf
   export fixgsi=$basedir/cloudy_radiance/fix
   export scripts=$basedir/cloudy_radiance/scripts
   export fixcrtm=/scratch4/NCEPDEV/da/save/Michael.Lueken/nwprod/lib/crtm/2.2.3/fix
   export tmpdir=/scratch3/NCEPDEV/stmp1/$LOGNAME
   export savdir=/scratch3/NCEPDEV/stmp1/$LOGNAME
