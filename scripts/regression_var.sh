...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/memversion/src
   export gsiexec_updat=$basedir/memversion/src/global_gsi
   export gsiexec_contrl=$basedir/memversion/src/global_gsi_save
   export enkfexec_updat=$basedir/trunk/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/svn1/src/enkf/global_enkf
   export fixgsi=$basedir/trunk/fix
   export scripts=$basedir/memversion/scripts
