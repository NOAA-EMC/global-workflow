...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/gsi_nsst_update/src
   export gsiexec_updat=$basedir/gsi_nsst_update/src/global_gsi
#  export gsiexec_contrl=$basedir/svn1/src/global_gsi
   ...
   export enkfexec_updat=$basedir/gsi_nsst_update/src/enkf/global_enkf
#  export enkfexec_contrl=$basedir/svn1/src/enkf/global_enkf
   export enkfexec_contrl=/scratch1/portfolios/NCEPDEV/da/save/Michael.Lueken/svn1/src/enkf/global_enkf
   export fixgsi=$basedir/gsi_nsst_update/fix
   export scripts=$basedir/gsi_nsst_update/scripts
