...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/EXP-testCRTM_zhu_submit/src
   export gsiexec_updat=$basedir/EXP-testCRTM_zhu_submit/src/global_gsi
   export gsiexec_contrl=$basedir/EXP-testCRTM_zhu_ctl/src/global_gsi
   export fixgsi=$basedir/EXP-testCRTM_zhu_submit/fix
   export scripts=$basedir/EXP-testCRTM_zhu_submit/scripts
