...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/EXP-singleradiance/src
   export gsiexec_updat=$basedir/EXP-singleradiance/src/global_gsi
   export gsiexec_contrl=$basedir/GSI-TRUNK-r45299/src/global_gsi
   export fixgsi=$basedir/EXP-singleradiance/fix
   export scripts=$basedir/EXP-singleradiance/scripts
...
export ptmp_loc="/scratch2/portfolios/NCEPDEV/ptmp/$USER"
