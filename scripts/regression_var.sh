...
#  fix, ptmp, and CRTM coefficient files.
   ...
   export gsisrc=$basedir/EXP-reg_4denvar_regression/src
   export gsiexec_updat=$basedir/EXP-reg_4denvar_regression/src/global_gsi
   export gsiexec_contrl=$basedir/svn1/src/global_gsi
   export enkfexec_updat=$basedir/EXP-reg_4denvar_regression/src/enkf/global_enkf
   export enkfexec_contrl=$basedir/svn1/src/enkf/global_enkf
   export fixgsi=$basedir/EXP-reg_4denvar_regression/fix
   export scripts=$basedir/EXP-reg_4denvar_regression/scripts
