...
job[1]=$arw_netcdf_updat_exp1
job[2]=$arw_netcdf_updat_exp2
job[3]=$arw_netcdf_contrl_exp1
job[4]=$arw_netcdf_contrl_exp2
...
if [ "$debug" = ".false." ]; then
   ...
   /bin/sh $scripts/regression_test.sh ${job[1]} ${job[2]} ${job[3]} ${job[4]} tmpreg_arw_netcdf $arw_netcdf_regression 4 8 4
