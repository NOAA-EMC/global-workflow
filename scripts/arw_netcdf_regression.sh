...
if [[ "$machine" = "Theia" ]]; then
   ...
   if [ "$debug" = ".false." ]; then
      /bin/sh sub_zeus -j $arw_netcdf_updat_exp1 -t 0:15:00 -p 4/4/0 -r /1 $scripts/arw_netcdf.sh
      ...
      /bin/sh sub_zeus -j $arw_netcdf_updat_exp2 -t 0:12:00 -p 6/6/0 -r /1 $scripts/arw_netcdf.sh
      ...
      /bin/sh sub_zeus -j $arw_netcdf_contrl_exp1 -t 0:15:00 -p 4/4/0 -r /1 $scripts/arw_netcdf.sh
      ...
      /bin/sh sub_zeus -j $arw_netcdf_contrl_exp2 -t 0:12:00 -p 6/6/0 -r /1 $scripts/arw_netcdf.sh
