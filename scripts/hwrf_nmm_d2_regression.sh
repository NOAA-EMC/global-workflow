...
if [ "$machine" = "Zeus" -o "$machine" = "Theia" ]; then
   ...
   if [ "$debug" = ".false." ]; then
      /bin/sh sub_zeus -j $hwrf_nmm_d2_updat_exp1 -t 0:20:00 -p 6/6/0 -r /1 $scripts/hwrf_nmm_d2.sh
      ...
      /bin/sh sub_zeus -j $hwrf_nmm_d2_updat_exp2 -t 0:15:00 -p 8/8/0 -r /1 $scripts/hwrf_nmm_d2.sh
      ...
      /bin/sh sub_zeus -j $hwrf_nmm_d2_contrl_exp1 -t 0:20:00 -p 6/6/0 -r /1 $scripts/hwrf_nmm_d2.sh
      ...
      /bin/sh sub_zeus -j $hwrf_nmm_d2_contrl_exp2 -t 0:15:00 -p 8/8/0 -r /1 $scripts/hwrf_nmm_d2.sh
      ...
      /bin/sh sub_zeus -j $hwrf_nmm_d2_updat_exp1 -p 6/6/ -t 0:35:00 $scripts/hwrf_nmm_d2.sh
   ...
   if [ "$debug" = ".false." ]; then
      /bin/sh sub_wcoss -a HWRF-T2O -j $hwrf_nmm_d2_updat_exp1 -q $queue -p 6/6/ -r /1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
      ...
      rm -f return_code_hwrf_nmm_d2.out
      /bin/sh sub_wcoss -a HWRF-T2O -j $hwrf_nmm_d2_updat_exp2 -q $queue -p 8/8/ -r /1 -t 0:15:00 $scripts/hwrf_nmm_d2.sh
      ...
      rm -f return_code_hwrf_nmm_d2.out
      /bin/sh sub_wcoss -a HWRF-T2O -j $hwrf_nmm_d2_contrl_exp1 -q $queue -p 6/6/ -r /1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
      ...
      rm -f return_code_hwrf_nmm_d2.out
      /bin/sh sub_wcoss -a HWRF-T2O -j $hwrf_nmm_d2_contrl_exp2 -q $queue -p 8/8/ -r /1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
      ...
      /bin/sh sub_wcoss -a HWRF-T2O -j $hwrf_nmm_d2_updat_exp1 -q $queue -p 6/6/ -t 0:35:00 $scripts/hwrf_nmm_d2.sh
