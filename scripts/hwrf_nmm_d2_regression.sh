...
if [[ "$arch" = "Linux" ]]; then
   ...
   /bin/sh sub -a RDAS-MTN -g $group -j $hwrf_nmm_d2_updat_exp1 -q $queue -p 6/6/N -r 110/1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
   ...
   rm -f return_code_hwrf_nmm_d2.out
   /bin/sh sub -a RDAS-MTN -g $group -j $hwrf_nmm_d2_updat_exp2 -q $queue -p 8/8/N -r 110/1 -t 0:15:00 $scripts/hwrf_nmm_d2.sh
   ...
   rm -f return_code_hwrf_nmm_d2.out
   /bin/sh sub -a RDAS-MTN -g $group -j $hwrf_nmm_d2_contrl_exp1 -q $queue -p 6/6/N -r 110/1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
   ...
   rm -f return_code_hwrf_nmm_d2.out
   /bin/sh sub -a RDAS-MTN -g $group -j $hwrf_nmm_d2_contrl_exp2 -q $queue -p 8/8/N -r 110/1 -t 0:20:00 $scripts/hwrf_nmm_d2.sh
