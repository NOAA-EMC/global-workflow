...
# Constants
atm_base_pattern = "{rot_dir}/{cdump}.%Y%m%d/%H/model/atmos/input"       # Location of atmosphere ICs
atm_file_pattern = "{path}/gfs_data.{tile}.nc"                                # Atm IC file names
atm_ctrl_pattern = "{path}/gfs_ctrl.nc"                                       # Atm IC control file name
restart_base_pattern = "{rot_dir}/{cdump}.%Y%m%d/%H/model/atmos/restart"   # Location of restart files (time of previous run)
