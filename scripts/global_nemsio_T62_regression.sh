...
if [[ "$arch" = "Linux" ]]; then
   ...
   /bin/sh sub -a GDAS-T2O -g $group -j $global_nemsio_T62_updat_exp1 -q $queue -p 32/1/N -r 110/1 -t 0:25:00 $scripts/global_nemsio_T62.sh
   ...
   rm -f return_code_global_nemsio_3dvar.out
   /bin/sh sub -a GDAS-T2O -g $group -j $global_nemsio_T62_updat_exp2 -q $queue -p 32/2/N -r 110/2 -t 0:15:00 $scripts/global_nemsio_T62.sh
   ...
   rm -f return_code_global_nemsio_3dvar.out
   /bin/sh sub -a GDAS-T2O -g $group -j $global_nemsio_T62_contrl_exp1 -q $queue -p 32/1/N -r 110/1 -t 0:25:00 $scripts/global_nemsio_T62.sh
   ...
   rm -f return_code_global_nemsio_3dvar.out
   /bin/sh sub -a GDAS-T2O -g $group -j $global_nemsio_T62_contrl_exp2 -q $queue -p 32/2/N -r 110/2 -t 0:15:00 $scripts/global_nemsio_T62.sh
