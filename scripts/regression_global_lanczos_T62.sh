...
if [[ $exp = $exp1_global_lanczos_updat ]]; then
   SETUP="lrun_subdirs=.true."
elif [[ $exp = $exp2_global_lanczos_updat ]]; then
   SETUP="lrun_subdirs=.true."
elif [[ $exp = $exp1_global_lanczos_cntrl ]]; then
   SETUP=""
elif [[ $exp = $exp2_global_lanczos_cntrl ]]; then
   SETUP=""
fi
GRIDOPTS=""
BKGVERR=""
