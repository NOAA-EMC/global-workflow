...
gsiexec=/da/save/$USER/EXP-testCRTM_zhu_submit/src/global_gsi

# Specify GSI fixed field
fixgsi=/da/save/$USER/EXP-testCRTM_zhu_submit/fix
...
/da/save/Michael.Lueken/EXP-testCRTM_zhu_submit/util/Radiance_bias_correction_Utilities/write_biascr_option.x -newpc4pred -adp_anglebc 4
