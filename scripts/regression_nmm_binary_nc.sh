...
#@ error=gsi_nmm_binary_update.e$(jobid)
#@ job_type=parallel
...
#@ error=gsi_nmm_binary_update2.e$(jobid)
#@ job_type=parallel
#@ network.MPI=sn_all,shared,us
#@ node = 3
#@ node_usage=not_shared
...
cat << EOF > gsiparm.anl
 ...
 &OBS_INPUT
  ...
  dval(20)=0.0,  dthin(20)=1,
   dfile(21)='hirs4bufr', dtype(21)='hirs4',     dplat(21)='metop-a',   dsis(21)='hirs4_metop-a',
  dval(21)=6.0,  dthin(21)=1,
  ...
  dval(25)=0.0,  dthin(25)=1,
   dfile(26)='airsbufr',  dtype(26)='airs',      dplat(26)='aqua',      dsis(26)='airs281SUBSET_aqua',
  dval(26)=20.0, dthin(26)=1,
  ...
  dval(60)=1.5,  dthin(60)=5,
   dfile(61)='iasibufr',  dtype(61)='iasi',      dplat(61)='metop-a',   dsis(61)='iasi616_metop-a',
  dval(61)=20.0, dthin(61)=1,
   dfile(62)='gomebufr',  dtype(62)='gome',      dplat(62)='metop-a',   dsis(62)='gome_metop-a',
  dval(62)=1.0,  dthin(62)=6,
 /
 &SUPEROB_RADAR
...
cd $scripts
rm -f gsi_nmm_binary_update.e*
rm -f gsi_nmm_binary_update2.e*
rm -f nmm_binary_regression.e*
