...
#@ job_name=gsi_nmm_binary
#@ error=gsi_nmm_binary.e$(jobid)
#@ job_type=parallel
...
datobs=$basedir/wx20rt/gsi_anl/cases/regional/nmm_binary/$adate
datges=$datobs
...
tmpdir=/ptmp/$LOGNAME/tmpreg/nmm_binary/$exp
savdir=/ptmp/$LOGNAME/outreg/nmm_binary/$exp
...
cat << EOF > gsiparm.anl
 &SETUP
   ...
   ndat=51,jpch=844,npred=5,iguess=-1,
 ...
 &OBS_INPUT
   ...
   dfile(24)='airsev',    dtype(24)='airs',      dplat(24)='aqua', dsis(24)='airs281SUBSET_aqua',dval(24)=20.0, dthin(24)=1,
   ...
   dfile(30)='airsev',    dtype(30)='amsua',     dplat(30)='aqua', dsis(30)='amsua_aqua',        dval(30)=10.0, dthin(30)=2,
...
berror=$fixpath/nam_nmm_berror.f77
specoef=$fixpath/nam_CRTM_SpcCoeff.f77
trncoef=$fixpath/nam_CRTM_TauCoeff.f77
...
satinfo=$fixpath/nam_satinfo.txt
satangl=$fixpath/nam_satangbias.txt
pcpinfo=$fixpath/global_pcpinfo.txt
ozinfo=$fixpath/global_ozinfo.txt
errtable=/nwprod/fix/nam_errtable.r3dv
convinfo=$fixpath/nam_convinfo.txt
...
$ncp $datobs/${prefixa}.prepbufr.tm00      ./prepbufr
...
#
$ncp $datges/${prefixg}.satbias.tm00            ./satbias_in
$ncp $datges/${prefixg}.satang.tm00             ./satbias_angle
...
rr2gg=$utilpath/wrf_nmm_binary_grads.fd/wrf_nmm_binary_grads
$rr2gg wrf_inout anl
$rr2gg wrf_ges   ges
