...
cp -f "/lfs/h2/emc/nems/noscrub/emc.nems/UFS_UTILS/reg_tests/chgres_cube/fix/C96/C96.mx100_oro_data.tile3.nc" "$DATA/"
cp -f "/lfs/h2/emc/nems/noscrub/emc.nems/UFS_UTILS/reg_tests/chgres_cube/fix/C96/C96.mx100_oro_data.tile4.nc" "$DATA/"
...
cat << EOF > ./fort.41
&config
mosaic_file_target_grid="C96_mosaic.nc"
...
vcoord_file_target_grid="global_hyblev.l64.txt"
