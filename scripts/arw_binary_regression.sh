...
if [[ "$machine" = "Zeus" ]]; then
   ...
   /bin/sh sub_zeus -j $arw_binary_updat_exp1 -t 0:15:00 -p 4/4/0 $scripts/arw_binary.sh
   ...
   /bin/sh sub_zeus -j $arw_binary_updat_exp2 -t 0:12:00 -p 6/6/0 $scripts/arw_binary.sh
   ...
   /bin/sh sub_zeus -j $arw_binary_contrl_exp1 -t 0:15:00 -p 4/4/0 $scripts/arw_binary.sh
   ...
   /bin/sh sub_zeus -j $arw_binary_contrl_exp2 -t 0:12:00 -p 6/6/0 $scripts/arw_binary.sh
   ...
   /bin/sh sub_wcoss -j $arw_binary_updat_exp1 -q $queue -p 16/1/ -r /1 -t 0:10:00 $scripts/arw_binary.sh
   ...
   rm -f return_code_arw_binary.out
   /bin/sh sub_wcoss -j $arw_binary_contrl_exp1 -q $queue -p 16/1/ -r /1 -t 0:10:00 $scripts/arw_binary.sh
