...
export global_T62_namelist=" 
 ...
 &OBS_INPUT
   ...
   dfile(17)='hirs2bufr',      dtype(17)='hirs2',     dplat(17)='n14',     dsis(17)='hirs2_n14',         dval(17)=0.0,  dthin(17)=1,  dsfcalc(17)=0,
   dfile(18)='hirs3bufr_skip', dtype(18)='hirs3',     dplat(18)='n16',     dsis(18)='hirs3_n16',         dval(18)=0.0,  dthin(18)=1,  dsfcalc(18)=0,
   dfile(19)='hirs3bufr',      dtype(19)='hirs3',     dplat(19)='n17',     dsis(19)='hirs3_n17',         dval(19)=0.0,  dthin(19)=1,  dsfcalc(19)=0,
   dfile(20)='hirs4bufr_skip', dtype(20)='hirs4',     dplat(20)='n18',     dsis(20)='hirs4_n18',         dval(20)=0.0,  dthin(20)=1,  dsfcalc(20)=0,
   dfile(21)='hirs4bufr_skip', dtype(21)='hirs4',     dplat(21)='metop-a', dsis(21)='hirs4_metop-a',     dval(21)=0.0,  dthin(21)=1,  dsfcalc(21)=0,
   ...
   dfile(26)='airsbufr',       dtype(26)='airs',      dplat(26)='aqua',    dsis(26)='airs281SUBSET_aqua',dval(26)=0.0,  dthin(26)=3,  dsfcalc(26)=0,
   dfile(27)='msubufr',        dtype(27)='msu',       dplat(27)='n14',     dsis(27)='msu_n14',           dval(27)=0.0,  dthin(27)=1,  dsfcalc(27)=0,
   dfile(28)='amsuabufr_skip', dtype(28)='amsua',     dplat(28)='n15',     dsis(28)='amsua_n15',         dval(28)=0.0,  dthin(28)=1,  dsfcalc(28)=0,
   dfile(29)='amsuabufr_skip', dtype(29)='amsua',     dplat(29)='n16',     dsis(29)='amsua_n16',         dval(29)=0.0,  dthin(29)=1,  dsfcalc(29)=0,
   dfile(30)='amsuabufr_skip', dtype(30)='amsua',     dplat(30)='n17',     dsis(30)='amsua_n17',         dval(30)=0.0,  dthin(30)=1,  dsfcalc(30)=0,
   dfile(31)='amsuabufr_skip', dtype(31)='amsua',     dplat(31)='n18',     dsis(31)='amsua_n18',         dval(31)=0.0,  dthin(31)=1,  dsfcalc(31)=0,
   dfile(32)='amsuabufr_skip', dtype(32)='amsua',     dplat(32)='metop-a', dsis(32)='amsua_metop-a',     dval(32)=0.0,  dthin(32)=1,  dsfcalc(32)=0,
   dfile(33)='airsbufr_skip',  dtype(33)='amsua',     dplat(33)='aqua',    dsis(33)='amsua_aqua',        dval(33)=0.0,  dthin(33)=1,  dsfcalc(33)=0,
   dfile(34)='amsubbufr_skip', dtype(34)='amsub',     dplat(34)='n15',     dsis(34)='amsub_n15',         dval(34)=0.0,  dthin(34)=1,  dsfcalc(34)=0,
   dfile(35)='amsubbufr_skip', dtype(35)='amsub',     dplat(35)='n16',     dsis(35)='amsub_n16',         dval(35)=0.0,  dthin(35)=1,  dsfcalc(35)=0,
   dfile(36)='amsubbufr',      dtype(36)='amsub',     dplat(36)='n17',     dsis(36)='amsub_n17',         dval(36)=0.0,  dthin(36)=1,  dsfcalc(36)=0,
   dfile(37)='mhsbufr_skip',   dtype(37)='mhs',       dplat(37)='n18',     dsis(37)='mhs_n18',           dval(37)=0.0,  dthin(37)=1,  dsfcalc(37)=0,
   dfile(38)='mhsbufr_skip',   dtype(38)='mhs',       dplat(38)='metop-a', dsis(38)='mhs_metop-a',       dval(38)=0.0,  dthin(38)=1,  dsfcalc(38)=0,
   ...
   dfile(42)='amsrebufr',      dtype(42)='amsre_low', dplat(42)='aqua',    dsis(42)='amsre_aqua',        dval(42)=0.0,  dthin(42)=1,  dsfcalc(42)=0,
   dfile(43)='amsrebufr',      dtype(43)='amsre_mid', dplat(43)='aqua',    dsis(43)='amsre_aqua',        dval(43)=0.0,  dthin(43)=1,  dsfcalc(43)=0,
   dfile(44)='amsrebufr',      dtype(44)='amsre_hig', dplat(44)='aqua',    dsis(44)='amsre_aqua',        dval(44)=0.0,  dthin(44)=1,  dsfcalc(44)=0,
   dfile(45)='ssmisbufr',      dtype(45)='ssmis',     dplat(45)='f16',     dsis(45)='ssmis_f16',         dval(45)=0.0,  dthin(45)=1,  dsfcalc(45)=0,
   ...
   dfile(58)='iasibufr',       dtype(58)='iasi',      dplat(58)='metop-a', dsis(58)='iasi616_metop-a',   dval(58)=0.0,  dthin(58)=4,  dsfcalc(58)=0,
   ...
   dfile(62)='hirs4bufr',      dtype(62)='hirs4',     dplat(62)='n19',     dsis(62)='hirs4_n19',         dval(62)=0.0,  dthin(62)=1,  dsfcalc(62)=0,
   dfile(63)='amsuabufr',      dtype(63)='amsua',     dplat(63)='n19',     dsis(63)='amsua_n19',         dval(63)=0.0,  dthin(63)=1,  dsfcalc(63)=0,
   dfile(64)='mhsbufr',        dtype(64)='mhs',       dplat(64)='n19',     dsis(64)='mhs_n19',           dval(64)=0.0,  dthin(64)=1,  dsfcalc(64)=0,
...
export arw_binary_namelist="
 ...
 &OBS_INPUT
   ...
   dfile(05)='satwnd',         dtype(05)='uv',        dplat(05)=' ',         dsis(05)='uv',                  dval(05)=0.0,  dthin(05)=0,
   dfile(06)='prepbufr',       dtype(06)='spd',       dplat(06)=' ',         dsis(06)='spd',                 dval(06)=0.0,  dthin(06)=0,
   dfile(07)='radarbufr',      dtype(07)='rw',        dplat(07)=' ',         dsis(07)='rw',                  dval(07)=0.0,  dthin(07)=0,
   dfile(08)='prepbufr',       dtype(08)='dw',        dplat(08)=' ',         dsis(08)='dw',                  dval(08)=0.0,  dthin(08)=0,
   dfile(09)='prepbufr',       dtype(09)='sst',       dplat(09)=' ',         dsis(09)='sst',                 dval(09)=0.0,  dthin(09)=0,
   dfile(10)='prepbufr',       dtype(10)='pw',        dplat(10)=' ',         dsis(10)='pw',                  dval(10)=0.0,  dthin(10)=0,
   dfile(11)='gpsrobufr',      dtype(11)='$gps_dtype',   dplat(11)=' ',         dsis(11)='gps',                 dval(11)=0.0,  dthin(11)=0,
   dfile(12)='ssmirrbufr',     dtype(12)='pcp_ssmi',  dplat(12)='dmsp',      dsis(12)='pcp_ssmi',            dval(12)=0.0,  dthin(12)=-1,
   dfile(13)='tmirrbufr',      dtype(13)='pcp_tmi',   dplat(13)='trmm',      dsis(13)='pcp_tmi',             dval(13)=0.0,  dthin(13)=-1,
   dfile(14)='sbuvbufr',       dtype(14)='sbuv2',     dplat(14)='n16',       dsis(14)='sbuv8_n16',           dval(14)=0.0,  dthin(14)=0,
   dfile(15)='sbuvbufr',       dtype(15)='sbuv2',     dplat(15)='n17',       dsis(15)='sbuv8_n17',           dval(15)=0.0,  dthin(15)=0,
   dfile(16)='sbuvbufr',       dtype(16)='sbuv2',     dplat(16)='n18',       dsis(16)='sbuv8_n18',           dval(16)=0.0,  dthin(16)=0,
   dfile(17)='omi',            dtype(17)='omi',       dplat(17)='aura',      dsis(17)='omi_aura',            dval(17)=0.0,  dthin(17)=4,
   dfile(18)='hirs2bufr',      dtype(18)='hirs2',     dplat(18)='n14',       dsis(18)='hirs2_n14',           dval(18)=0.0,  dthin(18)=1,
   dfile(19)='hirs3bufr',      dtype(19)='hirs3',     dplat(19)='n16',       dsis(19)='hirs3_n16',           dval(19)=0.0,  dthin(19)=1,
   dfile(20)='hirs3bufr',      dtype(20)='hirs3',     dplat(20)='n17',       dsis(20)='hirs3_n17',           dval(20)=0.0,  dthin(20)=1,
   dfile(21)='hirs4bufr',      dtype(21)='hirs4',     dplat(21)='n18',       dsis(21)='hirs4_n18',           dval(21)=0.0,  dthin(21)=1,
   dfile(22)='hirs4bufr',      dtype(22)='hirs4',     dplat(22)='metop-a',   dsis(22)='hirs4_metop-a',       dval(22)=0.0,  dthin(22)=1,
   dfile(23)='gsndrbufr',      dtype(23)='sndr',      dplat(23)='g11',       dsis(23)='sndr_g11',            dval(23)=0.0,  dthin(23)=1,
   dfile(24)='gsndrbufr',      dtype(24)='sndr',      dplat(24)='g12',       dsis(24)='sndr_g12',            dval(24)=0.0,  dthin(24)=1,
   dfile(25)='gimgrbufr',      dtype(25)='goes_img',  dplat(25)='g11',       dsis(25)='imgr_g11',            dval(25)=0.0,  dthin(25)=1,
   dfile(26)='gimgrbufr',      dtype(26)='goes_img',  dplat(26)='g12',       dsis(26)='imgr_g12',            dval(26)=0.0,  dthin(26)=1,
   dfile(27)='airsbufr',       dtype(27)='airs',      dplat(27)='aqua',      dsis(27)='airs281SUBSET_aqua',  dval(27)=0.0,  dthin(27)=2,
   dfile(28)='msubufr',        dtype(28)='msu',       dplat(28)='n14',       dsis(28)='msu_n14',             dval(28)=0.0,  dthin(28)=1,
   dfile(29)='amsuabufr',      dtype(29)='amsua',     dplat(29)='n15',       dsis(29)='amsua_n15',           dval(29)=0.0,  dthin(29)=1,
   dfile(30)='amsuabufr',      dtype(30)='amsua',     dplat(30)='n16',       dsis(30)='amsua_n16',           dval(30)=0.0,  dthin(30)=1,
   dfile(31)='amsuabufr',      dtype(31)='amsua',     dplat(31)='n17',       dsis(31)='amsua_n17',           dval(31)=0.0,  dthin(31)=1,
   dfile(32)='amsuabufr',      dtype(32)='amsua',     dplat(32)='n18',       dsis(32)='amsua_n18',           dval(32)=0.0,  dthin(32)=1,
   dfile(33)='amsuabufr',      dtype(33)='amsua',     dplat(33)='metop-a',   dsis(33)='amsua_metop-a',       dval(33)=0.0,  dthin(33)=1,
   dfile(34)='airsbufr',       dtype(34)='amsua',     dplat(34)='aqua',      dsis(34)='amsua_aqua',          dval(34)=0.0,  dthin(34)=1,
   dfile(35)='amsubbufr',      dtype(35)='amsub',     dplat(35)='n15',       dsis(35)='amsub_n15',           dval(35)=0.0,  dthin(35)=1,
   dfile(36)='amsubbufr',      dtype(36)='amsub',     dplat(36)='n16',       dsis(36)='amsub_n16',           dval(36)=0.0,  dthin(36)=1,
   dfile(37)='amsubbufr',      dtype(37)='amsub',     dplat(37)='n17',       dsis(37)='amsub_n17',           dval(37)=0.0,  dthin(37)=1,
   dfile(38)='mhsbufr',        dtype(38)='mhs',       dplat(38)='n18',       dsis(38)='mhs_n18',             dval(38)=0.0,  dthin(38)=1,
   dfile(39)='mhsbufr',        dtype(39)='mhs',       dplat(39)='metop-a',   dsis(39)='mhs_metop-a',         dval(39)=0.0,  dthin(39)=1,
   dfile(40)='ssmitbufr',      dtype(40)='ssmi',      dplat(40)='f13',       dsis(40)='ssmi_f13',            dval(40)=0.0,  dthin(40)=1,
   dfile(41)='ssmitbufr',      dtype(41)='ssmi',      dplat(41)='f14',       dsis(41)='ssmi_f14',            dval(41)=0.0,  dthin(41)=1,
   dfile(42)='ssmitbufr',      dtype(42)='ssmi',      dplat(42)='f15',       dsis(42)='ssmi_f15',            dval(42)=0.0,  dthin(42)=1,
   dfile(43)='amsrebufr',      dtype(43)='amsre_low', dplat(43)='aqua',      dsis(43)='amsre_aqua',          dval(43)=0.0,  dthin(43)=1,
   dfile(44)='amsrebufr',      dtype(44)='amsre_mid', dplat(44)='aqua',      dsis(44)='amsre_aqua',          dval(44)=0.0,  dthin(44)=1,
   dfile(45)='amsrebufr',      dtype(45)='amsre_hig', dplat(45)='aqua',      dsis(45)='amsre_aqua',          dval(45)=0.0,  dthin(45)=1,
   dfile(46)='ssmisbufr',      dtype(46)='ssmis',     dplat(46)='f16',       dsis(46)='ssmis_f16',           dval(46)=0.0,  dthin(46)=1,
   dfile(47)='gsnd1bufr_skip', dtype(47)='sndrd1',    dplat(47)='g12',       dsis(47)='sndrD1_g12',          dval(47)=0.0,  dthin(47)=1,
   dfile(48)='gsnd1bufr',      dtype(48)='sndrd2',    dplat(48)='g12',       dsis(48)='sndrD2_g12',          dval(48)=0.0,  dthin(48)=1,
   dfile(49)='gsnd1bufr_skip', dtype(49)='sndrd3',    dplat(49)='g12',       dsis(49)='sndrD3_g12',          dval(49)=0.0,  dthin(49)=1,
   dfile(50)='gsnd1bufr_skip', dtype(50)='sndrd4',    dplat(50)='g12',       dsis(50)='sndrD4_g12',          dval(50)=0.0,  dthin(50)=1,
   dfile(51)='gsnd1bufr_skip', dtype(51)='sndrd1',    dplat(51)='g11',       dsis(51)='sndrD1_g11',          dval(51)=0.0,  dthin(51)=1,
   dfile(52)='gsnd1bufr_skip', dtype(52)='sndrd2',    dplat(52)='g11',       dsis(52)='sndrD2_g11',          dval(52)=0.0,  dthin(52)=1,
   dfile(53)='gsnd1bufr',      dtype(53)='sndrd3',    dplat(53)='g11',       dsis(53)='sndrD3_g11',          dval(53)=0.0,  dthin(53)=1,
   dfile(54)='gsnd1bufr_skip', dtype(54)='sndrd4',    dplat(54)='g11',       dsis(54)='sndrD4_g11',          dval(54)=0.0,  dthin(54)=1,
   dfile(55)='gsnd1bufr_skip', dtype(55)='sndrd1',    dplat(55)='g13',       dsis(55)='sndrD1_g13',          dval(55)=0.0,  dthin(55)=1,
   dfile(56)='gsnd1bufr_skip', dtype(56)='sndrd2',    dplat(56)='g13',       dsis(56)='sndrD2_g13',          dval(56)=0.0,  dthin(56)=1,
   dfile(57)='gsnd1bufr_skip', dtype(57)='sndrd3',    dplat(57)='g13',       dsis(57)='sndrD3_g13',          dval(57)=0.0,  dthin(57)=1,
   dfile(58)='gsnd1bufr_skip', dtype(58)='sndrd4',    dplat(58)='g13',       dsis(58)='sndrD4_g13',          dval(58)=0.0,  dthin(58)=1,
   dfile(59)='iasibufr',       dtype(59)='iasi',      dplat(59)='metop-a',   dsis(59)='iasi616_metop-a',     dval(59)=0.0,  dthin(59)=3,
   dfile(60)='gomebufr',       dtype(60)='gome',      dplat(60)='metop-a',   dsis(60)='gome_metop-a',        dval(60)=0.0,  dthin(60)=4,
   dfile(61)='mlsbufr',        dtype(61)='mls',       dplat(61)='aura',      dsis(61)='mls_aura',            dval(61)=1.0,  dthin(61)=0,
 /
 &SUPEROB_RADAR
...
export arw_netcdf_namelist="
 ...
 &OBS_INPUT
   ...
   dfile(18)='hirs2bufr',      dtype(18)='hirs2',     dplat(18)='n14',       dsis(18)='hirs2_n14',           dval(18)=0.0,  dthin(18)=1,
   dfile(19)='hirs3bufr',      dtype(19)='hirs3',     dplat(19)='n16',       dsis(19)='hirs3_n16',           dval(19)=0.0,  dthin(19)=1,
   dfile(20)='hirs3bufr_skip', dtype(20)='hirs3',     dplat(20)='n17',       dsis(20)='hirs3_n17',           dval(20)=0.0,  dthin(20)=1,
   dfile(21)='hirs4bufr',      dtype(21)='hirs4',     dplat(21)='n18',       dsis(21)='hirs4_n18',           dval(21)=0.0,  dthin(21)=1,
   dfile(22)='hirs4bufr',      dtype(22)='hirs4',     dplat(22)='metop-a',   dsis(22)='hirs4_metop-a',       dval(22)=0.0,  dthin(22)=1,
   dfile(23)='gsndrbufr',      dtype(23)='sndr',      dplat(23)='g11',       dsis(23)='sndr_g11',            dval(23)=0.0,  dthin(23)=1,
   dfile(24)='gsndrbufr',      dtype(24)='sndr',      dplat(24)='g12',       dsis(24)='sndr_g12',            dval(24)=0.0,  dthin(24)=1,
   ...
   dfile(27)='airsbufr',       dtype(27)='airs',      dplat(27)='aqua',      dsis(27)='airs281SUBSET_aqua',  dval(27)=0.0,  dthin(27)=2,
   dfile(28)='msubufr',        dtype(28)='msu',       dplat(28)='n14',       dsis(28)='msu_n14',             dval(28)=0.0,  dthin(28)=1,
   dfile(29)='amsuabufr_skip', dtype(29)='amsua',     dplat(29)='n15',       dsis(29)='amsua_n15',           dval(29)=0.0,  dthin(29)=1,
   dfile(30)='amsuabufr',      dtype(30)='amsua',     dplat(30)='n16',       dsis(30)='amsua_n16',           dval(30)=0.0,  dthin(30)=1,
   dfile(31)='amsuabufr',      dtype(31)='amsua',     dplat(31)='n17',       dsis(31)='amsua_n17',           dval(31)=0.0,  dthin(31)=1,
   dfile(32)='amsuabufr_skip', dtype(32)='amsua',     dplat(32)='n18',       dsis(32)='amsua_n18',           dval(32)=0.0,  dthin(32)=1,
   dfile(33)='amsuabufr',      dtype(33)='amsua',     dplat(33)='metop-a',   dsis(33)='amsua_metop-a',       dval(33)=0.0,  dthin(33)=1,
   dfile(34)='airsbufr_skip',  dtype(34)='amsua',     dplat(34)='aqua',      dsis(34)='amsua_aqua',          dval(34)=0.0,  dthin(34)=1,
   dfile(35)='amsubbufr',      dtype(35)='amsub',     dplat(35)='n15',       dsis(35)='amsub_n15',           dval(35)=0.0,  dthin(35)=1,
   dfile(36)='amsubbufr',      dtype(36)='amsub',     dplat(36)='n16',       dsis(36)='amsub_n16',           dval(36)=0.0,  dthin(36)=1,
   dfile(37)='amsubbufr',      dtype(37)='amsub',     dplat(37)='n17',       dsis(37)='amsub_n17',           dval(37)=0.0,  dthin(37)=1,
   dfile(38)='mhsbufr_skip',   dtype(38)='mhs',       dplat(38)='n18',       dsis(38)='mhs_n18',             dval(38)=0.0,  dthin(38)=1,
   dfile(39)='mhsbufr',        dtype(39)='mhs',       dplat(39)='metop-a',   dsis(39)='mhs_metop-a',         dval(39)=0.0,  dthin(39)=1,
   dfile(40)='ssmitbufr',      dtype(40)='ssmi',      dplat(40)='f13',       dsis(40)='ssmi_f13',            dval(40)=0.0,  dthin(40)=1,
   dfile(41)='ssmitbufr',      dtype(41)='ssmi',      dplat(41)='f14',       dsis(41)='ssmi_f14',            dval(41)=0.0,  dthin(41)=1,
   dfile(42)='ssmitbufr',      dtype(42)='ssmi',      dplat(42)='f15',       dsis(42)='ssmi_f15',            dval(42)=0.0,  dthin(42)=1,
   ...
   dfile(51)='gsnd1bufr_skip', dtype(51)='sndrd1',    dplat(51)='g11',       dsis(51)='sndrD1_g11',          dval(51)=0.0,  dthin(51)=1,
   dfile(52)='gsnd1bufr_skip', dtype(52)='sndrd2',    dplat(52)='g11',       dsis(52)='sndrD2_g11',          dval(52)=0.0,  dthin(52)=1,
   dfile(53)='gsnd1bufr_skip', dtype(53)='sndrd3',    dplat(53)='g11',       dsis(53)='sndrD3_g11',          dval(53)=0.0,  dthin(53)=1,
   dfile(54)='gsnd1bufr_skip', dtype(54)='sndrd4',    dplat(54)='g11',       dsis(54)='sndrD4_g11',          dval(54)=0.0,  dthin(54)=1,
   dfile(55)='gsnd1bufr_skip', dtype(55)='sndrd1',    dplat(55)='g13',       dsis(55)='sndrD1_g13',          dval(55)=0.0,  dthin(55)=1,
   dfile(56)='gsnd1bufr_skip', dtype(56)='sndrd2',    dplat(56)='g13',       dsis(56)='sndrD2_g13',          dval(56)=0.0,  dthin(56)=1,
   dfile(57)='gsnd1bufr_skip', dtype(57)='sndrd3',    dplat(57)='g13',       dsis(57)='sndrD3_g13',          dval(57)=0.0,  dthin(57)=1,
...
export nems_nmmb_namelist="
 ...
 &OBS_INPUT
   ...
   dfile(19)='hirs3bufr',      dtype(19)='hirs3',     dplat(19)='n17',     dsis(19)='hirs3_n17',         dval(19)=0.0,  dthin(19)=1,  dsfcalc(19)=0,
   dfile(20)='hirs4bufr_skip', dtype(20)='hirs4',     dplat(20)='n18',     dsis(20)='hirs4_n18',         dval(20)=0.0,  dthin(20)=1,  dsfcalc(20)=0,
   dfile(21)='hirs4bufr',      dtype(21)='hirs4',     dplat(21)='metop-a', dsis(21)='hirs4_metop-a',     dval(21)=0.0,  dthin(21)=1,  dsfcalc(21)=0,
   dfile(22)='gsndrbufr',      dtype(22)='sndr',      dplat(22)='g11',     dsis(22)='sndr_g11',          dval(22)=0.0,  dthin(22)=1,  dsfcalc(22)=0,
   dfile(23)='gsndrbufr',      dtype(23)='sndr',      dplat(23)='g12',     dsis(23)='sndr_g12',          dval(23)=0.0,  dthin(23)=1,  dsfcalc(23)=0,
   dfile(24)='gimgrbufr',      dtype(24)='goes_img',  dplat(24)='g11',     dsis(24)='imgr_g11',          dval(24)=0.0,  dthin(24)=1,  dsfcalc(24)=0,
   dfile(25)='gimgrbufr',      dtype(25)='goes_img',  dplat(25)='g12',     dsis(25)='imgr_g12',          dval(25)=0.0,  dthin(25)=1,  dsfcalc(25)=0,
   dfile(26)='airsbufr',       dtype(26)='airs',      dplat(26)='aqua',    dsis(26)='airs281SUBSET_aqua',dval(26)=0.0,  dthin(26)=2,  dsfcalc(26)=0,
   dfile(27)='msubufr',        dtype(27)='msu',       dplat(27)='n14',     dsis(27)='msu_n14',           dval(27)=0.0,  dthin(27)=1,  dsfcalc(27)=0,
   dfile(28)='amsuabufr_skip', dtype(28)='amsua',     dplat(28)='n15',     dsis(28)='amsua_n15',         dval(28)=0.0,  dthin(28)=1,  dsfcalc(28)=0,
   dfile(29)='amsuabufr_skip', dtype(29)='amsua',     dplat(29)='n16',     dsis(29)='amsua_n16',         dval(29)=0.0,  dthin(29)=1,  dsfcalc(29)=0,
   dfile(30)='amsuabufr_skip', dtype(30)='amsua',     dplat(30)='n17',     dsis(30)='amsua_n17',         dval(30)=0.0,  dthin(30)=1,  dsfcalc(30)=0,
   dfile(31)='amsuabufr_skip', dtype(31)='amsua',     dplat(31)='n18',     dsis(31)='amsua_n18',         dval(31)=0.0,  dthin(31)=1,  dsfcalc(31)=0,
   dfile(32)='amsuabufr',      dtype(32)='amsua',     dplat(32)='metop-a', dsis(32)='amsua_metop-a',     dval(32)=0.0,  dthin(32)=1,  dsfcalc(32)=0,
   dfile(33)='airsbufr_skip',  dtype(33)='amsua',     dplat(33)='aqua',    dsis(33)='amsua_aqua',        dval(33)=0.0,  dthin(33)=1,  dsfcalc(33)=0,
   dfile(34)='amsubbufr_skip', dtype(34)='amsub',     dplat(34)='n15',     dsis(34)='amsub_n15',         dval(34)=0.0,  dthin(34)=1,  dsfcalc(34)=0,
   dfile(35)='amsubbufr_skip', dtype(35)='amsub',     dplat(35)='n16',     dsis(35)='amsub_n16',         dval(35)=0.0,  dthin(35)=1,  dsfcalc(35)=0,
   dfile(36)='amsubbufr',      dtype(36)='amsub',     dplat(36)='n17',     dsis(36)='amsub_n17',         dval(36)=0.0,  dthin(36)=1,  dsfcalc(36)=0,
   dfile(37)='mhsbufr_skip',   dtype(37)='mhs',       dplat(37)='n18',     dsis(37)='mhs_n18',           dval(37)=0.0,  dthin(37)=1,  dsfcalc(37)=0,
   dfile(38)='mhsbufr',        dtype(38)='mhs',       dplat(38)='metop-a', dsis(38)='mhs_metop-a',       dval(38)=0.0,  dthin(38)=1,  dsfcalc(38)=0,
   dfile(39)='ssmitbufr',      dtype(39)='ssmi',      dplat(39)='f13',     dsis(39)='ssmi_f13',          dval(39)=0.0,  dthin(39)=1,  dsfcalc(39)=0,
   dfile(40)='ssmitbufr',      dtype(40)='ssmi',      dplat(40)='f14',     dsis(40)='ssmi_f14',          dval(40)=0.0,  dthin(40)=1,  dsfcalc(40)=0,
   dfile(41)='ssmitbufr',      dtype(41)='ssmi',      dplat(41)='f15',     dsis(41)='ssmi_f15',          dval(41)=0.0,  dthin(41)=1,  dsfcalc(41)=0,
   dfile(42)='amsrebufr',      dtype(42)='amsre_low', dplat(42)='aqua',    dsis(42)='amsre_aqua',        dval(42)=0.0,  dthin(42)=1,  dsfcalc(42)=0,
   ...
   dfile(56)='gsnd1bufr_skip', dtype(56)='sndrd3',    dplat(56)='g13',     dsis(56)='sndrD3_g13',        dval(56)=0.0,  dthin(56)=1,  dsfcalc(56)=0,
   dfile(57)='gsnd1bufr_skip', dtype(57)='sndrd4',    dplat(57)='g13',     dsis(57)='sndrD4_g13',        dval(57)=0.0,  dthin(57)=1,  dsfcalc(57)=0,
   dfile(58)='iasibufr',       dtype(58)='iasi',      dplat(58)='metop-a', dsis(58)='iasi616_metop-a',   dval(58)=0.0,  dthin(58)=3,  dsfcalc(58)=0,
