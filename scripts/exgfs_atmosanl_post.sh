...
#####################################################################
# echo "-----------------------------------------------------"
# echo " exgfs_atmosanl_post.sh" 
# echo " Oct 23 Winterbottom -- Initial implementation."
# echo "-----------------------------------------------------"
#####################################################################

# TODO: This script should be identical to `exgfs_atmos_post.sh` but
# is only run for `anl`; can `exgfs_atmos_post.sh` be used rather than
