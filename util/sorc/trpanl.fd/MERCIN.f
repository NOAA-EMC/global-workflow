...
C                                                                       00163000
      DIMENSION ILVL(3,9)
      DATA    NLVLS/9/
      DATA    ILVL/4H700 ,1H ,1,4H500 ,1H ,2,4H150 ,1H ,3,4H300 ,1H ,4,
...
C                                                                       00163800
     ...
     1             4HITAC,1HH,5,4HTP P,1HR,6,4HW   ,1H ,7,4HRH  ,1H ,8/
C                                                                       00164300
C     TAU CONTROL TABLE                                                 00164400
C                                                                       00164500
      DIMENSION ITAU(3,5)
      DATA    NTAUS/5/
      DATA    ITAU/4H00HR,1H ,1,4H24HR,1H ,2,4H30HR,1H ,3,4H36HR,1H ,4,
     1             4H48HR,1H ,5/
C                                                                       00165000
...
C                                                                       00173800
      ...
      print 984,' 9999 slot check ',LVL1A,ILVL(1,k),LVL1B,ILVL(2,k)
 984  format(a15,1x,'>',a4,'< >',a4,'< >',a4,'< >',a4,'<')  
...
C                                                                       00180300
      DO 7315 IK=1,NFLDS
      print 73,' 9999 IFLD CHK',IFLD1a,IFLD(1,ik),IFLD1b,IFLD(2,ik)
 73   format(a20,2a4,x,a1,x,a1)
...
C                                                                       00182700
      DO 7335 IK=1,NFLDS
      print 73,' 9999 IFLD CHK',IFLD2a,IFLD(1,ik),IFLD2b,IFLD(2,ik)
