...
C   PRGMMR: LILLY            ORG: W/NMC412   DATE: 93-04-07
C
...
C     ...WHERE KHMBS IS SEQUENCED ACCORDING TO ILVLT
     ...
     2          4HLFM ,4H    ,4HNH25,4H01  ,4HPFAX,4H    ,4HNH40,4H053 ,
...
C     NAMLVL(2) = KHMBS(2,ILVLT)
      call byteswap(KHMBS(1,ILVLT), 8, 1)
      call byteswap(KHMBS(2,ILVLT), 8, 1)
...
C
      ...
      call byteswap(KHRUN(1,KRUN1), 8, 1)
      call byteswap(KHRUN(2,KRUN1), 8, 1)
      call byteswap(KHRUN(3,KRUN1), 8, 1)
      call byteswap(KHRUN(4,KRUN1), 8, 1)
