     ...
     1  dash1(2),
     1  dash2(2),
     1  dash3(2),dash4(2),shad(2),shad2(2),shad3(2),shad4(2)
         integer dash1,dash2,dash3,dash4,shad,shad2,shad3,shad4,
     1    dw1,dw2,dw3,dw4
 ...
 107    format(a50,2(/,5f16.4),/,2z17,4x,2z17,4x,2z17,/)
...
c         do k=1,48*119
c         fld1(k)=fld1(k)/10.
c         if (nflds .ge. 2) fld2(k)=fld2(k)/1.
c         if (nflds .ge. 3) fld3(k)=fld3(k)/1.
c         end do
