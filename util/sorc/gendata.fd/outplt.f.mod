...
CKUMAR      CHARACTER*1280 AFOS
      CHARACTER*1   AFOS(1280)     
      CHARACTER*1   OTABL(20000,100)
...
CKUMAR      EQUIVALENCE   (AFOS,OAFOS(1))
      EQUIVALENCE   (AFOS(1),OAFOS(1))
C 
      DATA          OAFOS  /1280*' '/
      DATA          IPOIN  /133/
...
C
             IREC = IREC + 1
CKUMAR             WRITE ( IAFS, REC=IREC ) AFOS
             WRITE ( IAFS, REC=IREC ) (AFOS(N),N=1,1280)
