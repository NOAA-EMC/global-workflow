...
C                .      .    .                                       .          
C SUBPROGRAM:    FORWND      FORM THE GRAPHICS FORMAT.                          
C   PRGMMR: LARRY SAGER      ORG: W/NMC41    DATE: 96-09-10                     
C                                                                               
C ABSTRACT: FORWND TAKES UNPACKED BUFR FORMAT AND CONVERTS IT                 
C   INTO A SIMPLE FORMAT FOR USE IN GRAPHICS PROGRAMS.                          
C                                                                               
C PROGRAM HISTORY LOG:                                                          
C   96-09-10  LARRY SAGER                                                       
C                                                                               
C USAGE:    CALL FORWND (HDR, ARR, IARR, KRET, IRETT1)            
...
C                                                                               
C$$$                                                                            
      SUBROUTINE FORWND (HDR, ARR,  IARR, KRET, IRET1)
C
