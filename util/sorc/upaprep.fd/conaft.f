...
C                .      .    .                                       .          
C SUBPROGRAM:    CONAFT      READ AIRCRAFT CONTROL CARDS                         
C   PRGMMR: LARRY SAGER      ORG: W/NMCXX    DATE: 96-08-27                     
C                                                                               
C ABSTRACT: CONAFT READS THE PROGRAM CONTROL CARD FILE FOR THE  
...
C                                                                               
C USAGE:    CALL CONAFT  (COUT, RIMS, IRET)                 
