...
if __name__ == "__main__":
    main()
diff --git a/.github/workflows/bash_code_analysis_report.yaml b/.github/workflows/bash_code_analysis_report.yaml
index 2f11391..a051ac5 100644
--- a/.github/workflows/bash_code_analysis_report.yaml
++ b/.github/workflows/bash_code_analysis_report.yaml
@@ -32,6 +32,13 @@ jobs:
