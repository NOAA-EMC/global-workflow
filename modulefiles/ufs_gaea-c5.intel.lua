...
prepend_path("MODULEPATH", "/gpfs/f5/ufs-ard/proj-shared/spack-stack/spack-stack-1.6.0/envs/unified-env/install/modulefiles/Core")
prepend_path("MODULEPATH", "/gpfs/f5/ufs-ard/proj-shared/spack-stack/modulefiles")
