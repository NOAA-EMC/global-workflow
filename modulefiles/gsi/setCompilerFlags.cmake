function (setIntel)
  ...
  if( (BUILD_RELEASE) OR (BUILD_PRODUCTION) )
    if( HOST-Jet )
      ...
      set( MKL_FLAG "" )
      set(GSI_Fortran_FLAGS "-axSSE4.2,AVX,CORE-AVX2 -DPOUND_FOR_STRINGIFY -fp-model source -assume byterecl -convert big_endian -implicitnone -D_REAL8_ ${OMPFLAG} ${MPI_Fortran_COMPILE_FLAGS}" PARENT_SCOPE)
      set(GSI_LDFLAGS "-liomp5" PARENT_SCOPE)
 
      set(ENKF_Fortran_FLAGS "-O3 -axSSE4.2,AVX,CORE-AVX2 -fp-model source -convert big_endian -assume byterecl -implicitnone  -DGFS -D_REAL8_ ${OMPFLAG} " PARENT_SCOPE)
      set(UTIL_Fortran_FLAGS "-O3 -axSSE4.2,AVX,CORE-AVX2 -fp-model source -convert big_endian -assume byterecl -implicitnone  -DWRF -D_REAL8_ ${OMPFLAG} " PARENT_SCOPE)
      set (BACIO_Fortran_FLAGS "-O3 -axSSE4.2,AVX,CORE-AVX2 -free -assume nocc_omp " PARENT_SCOPE )
      set (BUFR_Fortran_FLAGS " -c -g -traceback -O3 -axSSE4.2,AVX,CORE-AVX2 -r8 " PARENT_SCOPE )
