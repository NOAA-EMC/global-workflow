...
# LSBATCH: User input
#BSUB -J jgfs_awips_f012_20km_00
#BSUB -o /ptmpd3/Boi.Vuong/com/gfs_awips_f012_20km_00.o%J
#BSUB -e /ptmpd3/Boi.Vuong/com/gfs_awips_f012_20km_00.o%J
#BSUB -L /bin/sh
#BSUB -n 1
#BSUB -q debug
#BSUB -W 00:30
...
########################################################
# Execute the script.
$HOMEgfs/scripts/exgfs_grib_awips_20km.sh.ecf $fcsthrs
export err=$?; err_chk
########################################################
