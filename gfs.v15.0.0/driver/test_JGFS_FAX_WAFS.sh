...
# LSBATCH: User input
#BSUB -J jgfs_fax_wafs_f12_00
#BSUB -o /ptmpd3/Boi.Vuong/com/gfs_fax_wafs_f12_00.o%J
#BSUB -e /ptmpd3/Boi.Vuong/com/gfs_fax_wafs_f12_00.o%J
#BSUB -L /bin/sh
#BSUB -n 1
#BSUB -q debug
#BSUB -W 00:15
...
export envir=prod
export SENDDBN=NO
export job=gfs_fax_wafs_f${fhr}_${cyc}
export pid=${pid:-$$}
...
########################################################
# Execute the script.
$HOMEgfs/scripts/exgfs_fax_wafs.sh.ecf
export err=$?; err_chk
########################################################
