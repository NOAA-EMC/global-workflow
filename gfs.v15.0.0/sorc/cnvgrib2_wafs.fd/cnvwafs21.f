      subroutine cnvwafs21(ifl1,ifl2)
C$$$  SUBPROGRAM DOCUMENTATION BLOCK
C                .      .    .                                       .
C SUBPROGRAM:    cnvwafs21 
...
C
C USAGE:    CALL cnvwafs21(ifl1,ifl2)
...
!      
     ...
     &                kgds,igrid,iret)
         if (iret.ne.0) then
           print *,'cnvwafs21: could not create gds'
           cycle
         endif
     ...
     &                gfld%idrtmpl,kpds,iret)
         if (iret.ne.0) then
           print *,'cnvwafs21: could not create pds'
           cycle
         endif
         kpds(3)=igrid
C
