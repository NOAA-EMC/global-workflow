    ...
    do
        ...
        do
            if [ ${runtime} = "06" ] ; then
                ...
                export HPCGFS=$COMROOT/nawips/${envir}/gfs.${PDYm1}
                ...
                export HPCGFS=$COMROOT/nawips/${envir}/gfs.${PDYm2}
