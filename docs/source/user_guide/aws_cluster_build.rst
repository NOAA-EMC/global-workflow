...
===================================
Building the Initial Baseline Image
===================================
...
================================
Now that the initial base image build is complete, the cluster can be initialized. The AWS Parallelcluster yaml configuration file should be created with the section “CustomAmi” populated with the AMI ID previously generated by the Packer build process.
