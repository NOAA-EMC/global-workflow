...
BUCKET_BASE='${ROTDIR}/${RUN}.${YMD}/${HH}/${MEMDIR}'

declare -rx BUCKET_TOP_TMPL='${ROTDIR}/${RUN}.${YMD}/${HH}'
...
declare -rx BUCKET_ATMOS_ANALYSIS_TMPL=${BUCKET_BASE}'/analysis/atmos'
declare -rx BUCKET_SNOW_ANALYSIS_TMPL=${BUCKET_BASE}'/analysis/snow'
...
declare -rx BUCKET_ATMOS_BUFR_TMPL=${BUCKET_BASE}'/products/atmos/bufr'
declare -rx BUCKET_ATMOS_GEMPAK_TMPL=${BUCKET_BASE}'/products/atmos/gempak/${GRID}'
declare -rx BUCKET_ATMOS_GENESIS_TMPL=${BUCKET_BASE}'/products/atmos/cyclone/genesis_vital'
declare -rx BUCKET_ATMOS_TRACK_TMPL=${BUCKET_BASE}'/products/atmos/cyclone/tracks'
declare -rx BUCKET_ATMOS_GOES_TMPL=${BUCKET_BASE}'/products/atmos/goes_sim'
declare -rx BUCKET_ATMOS_IMAGERY_TMPL=${BUCKET_BASE}'/products/atmos/imagery'
declare -rx BUCKET_ATMOS_OZNMON_TMPL=${BUCKET_BASE}'/products/atmos/oznmon'
declare -rx BUCKET_ATMOS_RADMON_TMPL=${BUCKET_BASE}'/products/atmos/radmon'
declare -rx BUCKET_ATMOS_MINMON_TMPL=${BUCKET_BASE}'/products/atmos/minmon'
declare -rx BUCKET_ATMOS_WMO_TMPL=${BUCKET_BASE}'/products/atmos/wmo'

declare -rx BUCKET_WAVE_RESTART_TMPL=${BUCKET_BASE}'/model/wave/restart'
declare -rx BUCKET_WAVE_PREP_TMPL=${BUCKET_BASE}'/model/wave/prep'
declare -rx BUCKET_WAVE_HISTORY_TMPL=${BUCKET_BASE}'/model/wave/history'
declare -rx BUCKET_WAVE_GRID_TMPL=${BUCKET_BASE}'/products/wave/gridded'
declare -rx BUCKET_WAVE_STATION_TMPL=${BUCKET_BASE}'/products/wave/station'
declare -rx BUCKET_WAVE_GEMPAK_TMPL=${BUCKET_BASE}'/products/wave/gempak'
declare -rx BUCKET_WAVE_WMO_TMPL=${BUCKET_BASE}'/products/wave/wmo'

declare -rx BUCKET_OCEAN_HISTORY_TMPL=${BUCKET_BASE}'/model/ocean/history'
declare -rx BUCKET_OCEAN_RESTART_TMPL=${BUCKET_BASE}'/model/ocean/restart'
declare -rx BUCKET_OCEAN_INPUT_TMPL=${BUCKET_BASE}'/model/ocean/input'
declare -rx BUCKET_OCEAN_ANALYSIS_TMPL=${BUCKET_BASE}'/analysis/ocean'
declare -rx BUCKET_OCEAN_BMATRIX_TMPL=${BUCKET_BASE}'/bmatrix/ocean'
...
declare -rx BUCKET_ICE_ANALYSIS_TMPL=${BUCKET_BASE}'/analysis/ice'
declare -rx BUCKET_ICE_BMATRIX_TMPL=${BUCKET_BASE}'/bmatrix/ice'
declare -rx BUCKET_ICE_INPUT_TMPL=${BUCKET_BASE}'/model/ice/input'
declare -rx BUCKET_ICE_HISTORY_TMPL=${BUCKET_BASE}'/model/ice/history'
declare -rx BUCKET_ICE_RESTART_TMPL=${BUCKET_BASE}'/model/ice/restart'
...
declare -rx BUCKET_CHEM_HISTORY_TMPL=${BUCKET_BASE}'/model/chem/history'
declare -rx BUCKET_CHEM_ANALYSIS_TMPL=${BUCKET_BASE}'/analysis/chem'

declare -rx BUCKET_MED_RESTART_TMPL=${BUCKET_BASE}'/model/med/restart'
