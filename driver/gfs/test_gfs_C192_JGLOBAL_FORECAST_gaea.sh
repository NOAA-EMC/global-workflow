...
#PBS -S /bin/sh
#PBS -A ncep
#PBS -o gfs_forecast_low.o%J
#PBS -e gfs_forecast_low.o%J
#PBS -N gfs_forecast_low
#PBS -M 768
#PBS -extsched 'CRAYLINUX[]'
#PBS -l walltime=01:00:00
#PBS -l nodes=72:ppn=24
#PBS -cwd /gpfs/hps/emc/global/noscrub/emc.glopara/svn/gfs/work/gfs.v14.1.0/driver
