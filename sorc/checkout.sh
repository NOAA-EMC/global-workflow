...
if [[ ! -d fv3gfs.fd ]] ; then
    ...
    git clone --recursive --branch GFS.v16.4.0 https://github.com/ufs-community/ufs-weather-model.git fv3gfs.fd >> ${topdir}/checkout-fv3gfs.log 2>&1
    cd ${topdir}
else
...
if [[ ! -d verif-global.fd ]] ; then
    ...
    git clone --recursive --branch verif_global_v2.10.0.1 https://github.com/NOAA-EMC/EMC_verif-global.git verif-global.fd >> ${topdir}/checkout-verif-global.log 2>&1
    cd ${topdir}
else
