module sorting
use kinds, only: r_single,r_double,i_long,i_kind
public :: quicksort, isort
contains
...
! --------------------------------------------------------------------
   ...
   INTEGER FUNCTION  FindMinimum(x, Start, End)
      IMPLICIT  NONE
      INTEGER(i_kind), DIMENSION(1:), INTENT(IN) :: x
...
! --------------------------------------------------------------------
   ...
   SUBROUTINE  ISort(x, Size)
      IMPLICIT  NONE
      INTEGER(i_kind), DIMENSION(1:), INTENT(INOUT) :: x
