...
!    2016-02-10  S.Liu  use r_single type for xland 
!
!
!   input argument list:
!     mype        - processor ID
...
!      Attempt remapping if within 75 hPa (arbitrary)
          ...
          if (k_closest <= 0 .and. xland(i,j) /= 0.0) then
