...
! local
   ...
   meta_nemsio%recname(1)    = 'albdo'
   meta_nemsio%reclevtyp(1)  = 'sfc'
   meta_nemsio%recname(2)    = 'cprat'
   meta_nemsio%reclevtyp(2)  = 'sfc'
   meta_nemsio%recname(3)    = 'prate'
   meta_nemsio%reclevtyp(3)  = 'sfc'
   meta_nemsio%recname(4)    = 'dlwrf'
   meta_nemsio%reclevtyp(4)  = 'sfc'
   meta_nemsio%recname(5)    = 'ulwrf'
   meta_nemsio%reclevtyp(5)  = 'sfc'
   meta_nemsio%recname(6)    = 'dswrf'
   meta_nemsio%reclevtyp(6)  = 'sfc'
   meta_nemsio%recname(7)    = 'uswrf'
   meta_nemsio%reclevtyp(7)  = 'sfc'
   meta_nemsio%recname(8)    = 'dswrf'
   meta_nemsio%reclevtyp(8)  = 'nom. top'
   meta_nemsio%recname(9)    = 'uswrf'
   meta_nemsio%reclevtyp(9)  = 'nom. top'
   meta_nemsio%recname(10)   = 'ulwrf'
   meta_nemsio%reclevtyp(10) = 'nom. top'
   meta_nemsio%recname(11)   = 'gflux'
   ...
   meta_nemsio%recname(15)   = 'slmsk'
   meta_nemsio%reclevtyp(15) = 'sfc'
   meta_nemsio%recname(16)   = 'lhtfl'
   meta_nemsio%reclevtyp(16) = 'sfc'
   meta_nemsio%recname(17)   = 'shtfl'
   ...
   meta_nemsio%recname(34)   = 'uflx'
   meta_nemsio%reclevtyp(34) = 'sfc'
   meta_nemsio%recname(35)   = 'vflx'
   ...
   meta_nemsio%recname(45)   = 'tcdcclm'
   meta_nemsio%reclevtyp(45) = 'sfc'
   meta_nemsio%recname(46)   = 'tcdchcl'
   meta_nemsio%reclevtyp(46) = 'sfc'
   meta_nemsio%recname(47)   = 'tcdclcl'
   meta_nemsio%reclevtyp(47) = 'sfc'
   meta_nemsio%recname(48)   = 'tcdcmcl'
   meta_nemsio%reclevtyp(48) = 'sfc'
