...
WIND    = bk9/0.7/1/112
TITLE   = 5/-2/~ ? ${MDL} MSLP,1000-850 THK,BL WND,6HR PCP|^ EPac PCP,MSLP,THK!0
TEXT    = 1.2/22/2/hw
CLRBAR	= 1
li
run
...
TITLE   = 5/-2/~ ? ${MDL} MSLP,1000-850 THK,BL WND,6HR CONV PCP|^ EPac CONV PCP,MSLP,THK!0
li
run

! Do 850 & 925mb stability
...
REFVEC  =
TITLE   = 1/-2/~ PMSL, THETA (850-sfc), @ WND (kts)|~ EPAC 850 STBLTY!0
TEXT    = 1/22/2/hw
CLEAR   = YES
l
r
...
TITLE   = 1/-2/~ PMSL, THETA (925-sfc), @ WND (kts)|~ EPAC 925 STBLTY!0
l
r
...
WIND    = ! ! Bk18//1
REFVEC  =
TITLE   = 1/-2/~ ? ${MDL} @ HEIGHTS, RH and OMEGA |~ EPac @ HGHT, RH & OMEGA!0
li
run
exit
EOFplt
