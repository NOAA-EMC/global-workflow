...
export COMIN00=${COMINgempak}/${mdl}.${PDY}/00/atmos/gempak
export COMIN06=${COMINgempak}/${mdl}.${PDY}/06/atmos/gempak
export COMIN12=${COMINgempak}/${mdl}.${PDY}/12/atmos/gempak
export COMIN18=${COMINgempak}/${mdl}.${PDY}/18/atmos/gempak
if [ ${cyc} -eq 00 ] ; then
    ...
    do
        ...
        do
            if [ ${runtime} = "06" ] ; then
                ...
                export HPCGFS=${COMINgempak}/${mdl}.${PDYm1}/${cyc2}/atmos/gempak
                ...
                export HPCGFS=${COMINgempak}/${mdl}.${PDYm2}/${cyc2}/atmos/gempak
    ...
    do
        ...
        do
            if [ ${runtime} -eq 00 ] ; then
                ...
                cyc2="06"
                desc="Y"
                export HPCGFS=${COMINgempak}/${NET}/${envir}/${mdl}.${PDYm1}/${cyc2}/atmos/gempak
