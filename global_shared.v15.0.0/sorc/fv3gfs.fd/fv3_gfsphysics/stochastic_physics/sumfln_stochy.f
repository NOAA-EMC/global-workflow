     ...
     &                         lons_lat,londi,latl,nvars_0,Atm)
!
...
!$omp parallel do private(node)
      ...
      n2=1
      do node=1,nodes
         do jj=1,ls_dim*workdim
            do nvar=1,nvars
               work1ds(n2)=works(1,nvar,jj,node)
               n2=n2+1
               work1ds(n2)=works(2,nvar,jj,node)
               n2=n2+1
            enddo
         enddo
      enddo
...
!         do jj=1,ls_dim*workdim
!            do nvar=1,nvars
!               workr(1,nvar,jj,node)=work1dr(n2)
!               n2=n2+1
!               workr(2,nvar,jj,node)=work1dr(n2)
!               n2=n2+1
!            enddo
!         enddo
!      enddo
