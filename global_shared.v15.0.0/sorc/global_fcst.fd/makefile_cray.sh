...
#-------------------------------------------------
#to be removed after bacio_v2.0.1p is implemented
# . /usrx/local/Modules/3.2.10/init/ksh
# module unload bacio/v2.0.1
...
#----------------------------
export F77M=${FCMP:-mpiifort}
export F90M=${FCMP:-mpiifort}
export F77B=$F77M
export FCC=${CCMP:-mpcc}
export LDRM=${FCMP:-mpiifort}
export FRRM=-FR
