...
!
      ...
      contains
! -------------------------------------------------------------------   
      subroutine reduce_grid (numreduce,jcap,lonf,latg,lons_lat)
      implicit none
...
c
      ...
      integer j,k,l,jtime,ktime,ltime
...
! -------------------------------------------------------------
      ...
      implicit none
c
      real(kind=kind_qdt_prec) eps,si,rl2,scale,dradz,rad,drad,p2,p1,pi
!     real(kind=kind_qdt_prec) x,w,sn,rc
