module namelist_def
  ...
  namelist /share/    debug, nlons,nlats,ntrunc,datapathout2d,datapathout3d,             &
       & analysis_filename, forecast_timestamp, nemsio_opt, variable_table
  namelist /interpio/ esmf_bilinear_filename, esmf_neareststod_filename             
