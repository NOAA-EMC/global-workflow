subroutine update_ctl_horiz(n_chan,iyy,imm,idd,ihh,idhh,incr,&
     ctl_file,lunctl)
...
300  continue
  ...
  nline=iline
  write(6,*)'update_ctl_horiz:  read nline=',nline,' lines from ctl file'
...
! Return
  return
end subroutine update_ctl_horiz
