...
#            see source code for details - /nwprod/global_shared.vX.Y.Z/sorc/emcsfc_snow2mdl.fd
#
...
HOMEglobal=${HOMEglobal:-$NWROOT/global_shared.${global_shared_ver:?}}
...
CLIMO_QC=${CLIMO_QC:-${FIXglobal}/emcsfc_snow_cover_climo.grib2}
