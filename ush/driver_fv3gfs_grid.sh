...
if [ $gtype = uniform ];  then
  ...
  echo 
  echo "............ execute make_grid.sh ................."
  $script_dir/make_grid.sh $res $grid_dir $script_dir

  for tile in 1 2 3 4 5 6 ; do
    echo 
    echo "............ execute make_orog.sh for tile $tile .................."
    $script_dir/make_orog.sh $res $tile $grid_dir $orog_dir $script_dir $topo $TMPDIR
  done
  ...
  echo 
  echo "............ execute make_grid.sh ................."
  $script_dir/make_grid.sh $res $grid_dir $stetch_fac $target_lon $target_lat $script_dir
  ...
  echo 
  echo "............ execute make_grid.sh ................."
  $script_dir/make_grid.sh $res $grid_dir $stetch_fac $target_lon $target_lat $refine_ratio $istart_nest $jstart_nest $iend_nest $jend_nest $halo $script_dir
