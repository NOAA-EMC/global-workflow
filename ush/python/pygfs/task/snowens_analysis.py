...
class SnowEnsAnalysis(Task):
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.task_config['CASE'] = self.task_config['CASE_ENS']
        ...
        expected_keys = ['snowanlvar', 'esnowanlensmean']
    ...
    def initialize(self) -> None:
        ...
        # stage orography
        logger.info(f"Staging orography files from {self.task_config.STAGE_OROG_TMPL}")
        orog_staging_dict = parse_j2yaml(self.task_config.STAGE_OROG_TMPL, self.task_config)
        ...
        logger.info(f"Staging GTS bufr2ioda mapping YAML files from {self.task_config.STAGE_GTS_TMPL}")
        gts_mapping_list = parse_j2yaml(self.task_config.STAGE_GTS_TMPL, self.task_config)
