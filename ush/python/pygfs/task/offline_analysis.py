...
class OfflineAnalysis(Task):
    ...
    def finalize(self) -> None:
        ...
        transfer_files.append([os.path.join(self.task_config.COMIN_ATMOS_ANALYSIS.replace('analysis', ''), f"{self.task_config.APREFIX_IN}analysis.dtf.i006.nc"),
                               os.path.join(self.task_config.COMOUT_ATMOS_ANALYSIS, f"{self.task_config.APREFIX}analysis.dtf.i006.nc")])
