...
class EnsembleRecenter(Task):
    ...
    def initialize(self) -> None:
        ...
        logger.info(f"Staging background and increment files from {self.task_config.ATM_ECEN_INITIALIZE_TMPL}")
        fh_dict = parse_j2yaml(self.task_config.ATM_ECEN_INITIALIZE_TMPL, self.task_config)
