...
class ArchiveTar:
    ...
    def get_all_yaml_vars(config_dict: AttrDict) -> Dict[str, Any]:
        ...
        arch_dict.update(ArchiveTar.add_config_vars(config_dict))

        # Add cycle-specific variables
        arch_dict.update(ArchiveTar._get_cycle_vars(config_dict))
    ...
    def get_member_com_paths(config_dict: AttrDict, member: int) -> Dict[str, str]:
        ...
        cycle_dict = ArchiveTar._create_cycle_dicts(config_dict)['temp_dict']
        ...
        member_com_paths = {
            com_key: ArchiveTar._replace_template_vars(config_dict.get(template_key, ""), cycle_dict)
        ...
        if config_dict.get('COM_CONF_TMPL'):
            member_com_paths['COMIN_CONF'] = ArchiveTar._replace_template_vars(
