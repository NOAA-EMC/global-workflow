...
class MarineBMat(Task):
    ...
    def initialize(self: Task) -> None:
        ...
        if self.task_config.DOHYBVAR_OCN == "YES" or self.task_config.NMEM_ENS >= 2:
            ...
            letkf_stage_list = parse_j2yaml(self.task_config.STAGE_ENS_BKG_TMPL, self.task_config)
    ...
    def finalize(self: Task) -> None:
        ...
        soca_finalize_list = parse_j2yaml(self.task_config.FINALIZE_TMPL, self.task_config)
