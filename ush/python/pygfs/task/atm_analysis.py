...
##        FileHandler({'copy': inclist}).sync()
        ...
        print(f" ")
        print(f"cdate_fv3 is {self.task_config.cdate_fv3}")
        cdate_inc = self.task_config.cdate_fv3.replace('.', '_')
        print(f"cdate_inc is {cdate_inc}")
        print(f"CDUMP is {self.task_config['CDUMP']}")
        print(f"cyc is {self.runtime_config['cyc']:02d}")
        print(f"src is {src}")
